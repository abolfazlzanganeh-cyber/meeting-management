...
export function NewResolution() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert(`✅ مصوبه ایجاد شد\n📧 اعلان برای ${formData.assigneeIds.length} نفر از مسئولین ارسال گردید`);
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">پس از ثبت، اعلان برای مسئولین ارسال می‌شود</p>
        </div>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-medium mb-1">عنوان مصوبه *</label>
            ...
            <div>
              <label className="block text-sm font-medium mb-1">اقدام مورد انتظار</label>
              <textarea value={formData.expectedAction}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <input required type="text" value={formData.startDate}
              ...
              <div>
                ...
                <input required type="text" value={formData.dueDate}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium mb-1">جلسه مرتبط (اختیاری)</label>
                <select value={formData.meetingId}
            ...
            <div>
              ...
              <div className="border border-slate-200 rounded-lg p-3 max-h-64 overflow-y-auto">
                {(users || []).map(user => (
                  <label key={user.id} className="flex items-center gap-2 py-2 px-2 cursor-pointer hover:bg-slate-50 rounded">
                    <input type="checkbox"
                    ...
                    <div className="flex-1">
                      ...
                      <span className="text-xs text-slate-500 mr-2">({user.position})</span>
                    </div>
                  </label>
                ))}
              </div>
